...
#define AWS_IAM_KEY_ID                 "AKIAITIOGE7F7CNEORQQ"
#define AWS_IAM_SECRET_KEY             "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"

#define AWS_IOT_ENDPOINT               "a322w7hjd4apek"
#define AWS_IOT_MQTT_HOST              "a322w7hjd4apek.iot.us-east-1.amazonaws.com" ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              443 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "esp8266-1" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "LivingRoomHVAC" ///< Thing Name of the Shadow this device is associated with
