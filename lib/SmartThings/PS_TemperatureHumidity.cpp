...
//public
	...
	PS_TemperatureHumidity::PS_TemperatureHumidity(const __FlashStringHelper *name, unsigned int interval, int offset, byte digitalInputPin, String strTemp, String strHumid, bool In_C, byte filterConstant) :
